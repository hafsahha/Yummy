...
<head>
	...
	<title>Abadeez Sport Center</title>
		...
		<div class="container" data-aos="fade-up">
			<div class="row justify-content-center">
				<div class="col-md-10 text-center">
					...
					<a href="membership.php" class="btn-book-a-table">Daftar Membership</a>
				</div>
			</div>
		</div>
		...
		<div class="container" data-aos="fade-up">
			...
			<div class="row gy-4">
				<div class="col-lg-7 position-relative about-img" 
					style="background-image: url(assets/img/about.jpg); background-size: cover;" data-aos="fade-up" data-aos-delay="150">
    ...
    <section id="why-us" class="why-us section-bg">
		<div class="container" data-aos="fade-up">
			...
			<div class="row gy-4">
				...
				<div class="col-lg-4 my-4" data-aos="fade-up" data-aos-delay="100">
					<div class="why-box" style="height:100%;">
						<h3>Why Choose Abadeez?</h3>
						<p>Pesan lapangan, reservasi ruang, atau amankan fasilitas olahraga apa pun di Abadi Sport Center dengan Abadeez, mitra pemesanan olahraga Anda yang terpercaya.</p>
				...
				<div class="col-lg-8 d-flex align-items-center">
					<div class="row gy-4 d-flex flex-nowrap" style="overflow: auto; scrollbar-width: none;">

						<div class="col-xl-4 my-4" data-aos="fade-up" data-aos-delay="200" style="flex: 0 0 auto;">
						...
						<div class="col-xl-4 my-4" data-aos="fade-up" data-aos-delay="300" style="flex: 0 0 auto;">
							<div class="icon-box d-flex flex-column align-items-center">
						...
						<div class="col-xl-4 my-4" data-aos="fade-up" data-aos-delay="400" style="flex: 0 0 auto;">
								<div class="icon-box d-flex flex-column align-items-center">
		...
		<div class="container" data-aos="fade-up">
			...
			<div class="tab-content" data-aos="fade-up" data-aos-delay="300">
				<div class="tab-pane fade active show" id="menu-starters">
					...
					<div class="row gy-5 d-flex flex-nowrap" style="overflow: auto; scrollbar-width: none;">
					<?php
